...
window['globals'] = {
    ProblemCategories: [
        ...
        { name: 'Relativistic Mechanics', id: 7 },
        { name: 'Electricity and Magnetism', id: 8 },
        { name: 'Computer Science', id: 9 },
        { name: 'Quantitative Finance', id: 10 },
        { name: 'Chemistry', id: 11 },
        { name: 'Biology', id: 12 },
        { name: 'Probability', id: 13 },
        { name: 'Contest Math', id: 14 },
        { name: 'Multi-topic', id: 15 },
        { name: 'Others', id: 16 },
    ],
